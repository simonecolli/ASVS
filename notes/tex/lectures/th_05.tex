...
In LiSA, il codice sorgente viene tradotto da un front-end specifico per il
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/th_05/05.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/th_05/06.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{images/th_05/07.png}

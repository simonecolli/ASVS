...
$[[P]]$, e una proprietà target $Q$ che si vuole verificare verificare.
...
Per questo motivo si ricorre ad un'approssimazione ${[[P]]}^{\#}$ di $[[P]]$.
...
dell'inclusione, è concludere che anche il programma reale è
sicuro ($[[P]] \subseteq Q$).
...
Quando si analizza un protramma è necessario considerare oggetti che rappresentano
...
Nal caso di approssimazione dal basso, $P^{\#} \subseteq P$ se un elemento
...
\begin{itemize}
    ...
    Se l'elemento non si trova nell'insieme astratto, non possiamo concludere
    ...
    sottoinsieme di $P$, siamo certi che l'elemento appartenga anche
...
permettono di passare da uno stato corrente al successivo, creando un
...
Così facendo però rimane ancora il problema della undecidibilità, poiché gli
...
\begin{nota}{Aggiunta di rumore}{loss_of_precision}

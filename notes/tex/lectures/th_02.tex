...
\begin{esempio}{Esempio di catena ascendente infinita non è strettamente crescente}{}
...
\begin{definizione}{Mappa continua}{def:continuous_map}
...
\begin{nota}{Utilità delle mappe continue}{nota:continuous_map_usefulness}
...
\begin{teorema}{Teorema di Knaster-Tarski}{knaster_tarski}
    ...
    Sia $\langle X, \sqsubseteq, \sqcup, \sqcap \rangle$ un reticolo e sia
...
completo e sia $f: X \to X$ una funzione continua (\Cref{def:monotonicity_embedding_isomorphism}).
